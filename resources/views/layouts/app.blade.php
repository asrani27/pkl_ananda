      ...
      <div class="inner_container">
         ...
         <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
               ...
               <li><a href="/admin/data/verifikasi/data"><i class="fa fa-share-square-o"></i> <span>Verifikasi Perubahan / Pembaruan Data Pegawai</span></a></li>
               ...
               <li>
                  ...
                  <ul class="collapse list-unstyled" id="masterSubmenu">
                     ...
                     <li><a href="/admin/data/jeniscuti"><i class="fa fa-calendar"></i> <span>Jenis Cuti</span></a></li>
                  </ul>
               </li> 
            ...
            @if(Auth::user()->roles == 'pegawai')
               <ul class="list-unstyled components">
                  ...
                  <a href="/pegawai/data/perubahandata"><i class="fa fa-send"></i> <span>Pengajuan Perubahan / Pembaruan Data</span></a></li>
