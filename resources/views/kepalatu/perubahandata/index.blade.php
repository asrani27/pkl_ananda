...
<div class="white_shd full margin_bottom_30">
   <div class="full graph_head">
      <div class="heading1 margin_0">
         ...
         <a href="/kepalatu/data/perubahandata/create" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-plus"></i>
            Tambah
            Data</a>
      </div>
   </div>
         ...
         <table class="table table-bordered" id="myTable">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <a href="/kepalatu/data/perubahandata/edit/{{$item->id}}" class="btn btn-flat btn-sm btn-success"><i
                           class="fa fa-edit"></i> Edit</a>
                     <a href="/kepalatu/data/perubahandata/delete/{{$item->id}}" class="btn btn-flat btn-sm btn-danger"
