...
<body class="inner_page login" style="background-image: url('/background/bg.jpg'); background-size:cover">
         ...
         <div class="center verticle_center full_height">
            <div class="login_section" style="min-height: 100px;">
               <div class="logo_login">
                  <div class="center">
                     <h1 style="color:aliceblue; font-size:26px; text-align:center"><img src="/background/logo.png"
                           width="15%"><br /> <br /> SIPANDU UPPD BJM 1</h1>
                  </div>
               </div>
               ...
               <div class="text-center text-bold" style="color: black">
                  JALAN JEND. A.YANI Km. 6 KODE POS. 70249 KALIMANTAN SELATAN, <br />Telp : ( 0511)
                  3257025, E-mail : dispenda.uppdbjm1@gmail.com</div>
            </div>
         </div>
      </div>
   </div>
